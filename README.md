...
In the file, add `MONGODB_URI=your_mongodb_uri`
...
## Deploy on Vercel
You can check the deployed site on [https://backend-guild-pt-next.vercel.app/](https://backend-guild-pt-next.vercel.app/)
